...
// Класс для тега [abbr]
class bb_abbr extends lib_bbcode {
    var $ends = array(
...
class bb_acronym extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
class bb_address extends lib_bbcode {
    var $rbr = 1;
...
class bb_align extends lib_bbcode {
    var $rbr = 1;
    var $ends = array('*','tr','td','th');
    function get_html() {
        $align = '';
...
class bb_bbcode extends lib_bbcode {
    var $ends = array();
    var $children = array();
    function get_html() {
        $str = '';
...
class bb_caption extends lib_bbcode {
    var $ends = array('tr');
    var $children = array(
...
// Класс для тега [code]
class bb_code extends lib_bbcode {
    var $ends = array();
    var $children = array();
    function get_html() {
        $str = '<code class="bb">';
...
class bb_color extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
class bb_del extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
class bb_email extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
// Класс для тега [font]
class bb_font extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
class bb_google extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
// Класс для тега [h1]
class bb_h1 extends lib_bbcode {
    var $lbr = 1;
    var $rbr = 2;
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
...
// Класс для тега [h2]
class bb_h2 extends lib_bbcode {
    var $lbr = 1;
    var $rbr = 2;
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
...
// Класс для тега [h3]
class bb_h3 extends lib_bbcode {
    var $lbr = 1;
    var $rbr = 2;
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
...
// Класс для тега [hr]
class bb_hr extends lib_bbcode {
    var $is_close = true;
    var $rbr = 1;
    var $ends = array();
    var $children = array();
...
// Класс для тега [img]
class bb_img extends lib_bbcode {
    var $ends = array();
    var $children = array();
    function get_html() {
        $attr = 'alt=""';
...
// Класс для тега [*]
class bb_li extends lib_bbcode {
    var $ends = array('*','tr','td','th');
    function get_html() {
        $attrib = 'class="bb"';
        if ('' !== $this -> attrib['*']) {
...
// Класс для тега [list]
class bb_list extends lib_bbcode {
    var $lbr = 0;
    var $rbr = 2;
    var $ends = array();
    var $children = array('*');
...
// Класс для тега [nobb]
class bb_nobb extends lib_bbcode {
    var $ends = array();
    var $children = array();
    function get_html() {
        $str = '';
...
// Класс для тега [php]
class bb_php extends lib_bbcode {
    var $ends = array();
    var $children = array();
    function get_html() {
        $str = '';
...
class bb_quote extends lib_bbcode {
    var $rbr = 1;
    var $ends = array();
    function get_html() {
...
// Класс для тега [size]
class bb_size extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
// Класс для тега [b]
class bb_strong extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
// Класс для тега [sub]
class bb_sub extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
// Класс для тега [sup]
class bb_sup extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
...
class bb_table extends lib_bbcode {
    var $rbr = 1;
...
// Класс для тега [td]
class bb_td extends lib_bbcode {
...
// Класс для тега [th]
class bb_th extends lib_bbcode {
    var $ends = array('td','th','tr');
    function get_html() {
        $attr = ' class="bb"';
        $width = isset($this -> attrib['width']) ? $this -> attrib['width'] : '';
...
// Класс для тега [tr]
class bb_tr extends lib_bbcode {
    var $ends = array('tr');
...
// Класс для тега [tt]
class bb_tt extends lib_bbcode {
    var $ends = array(
        '*','address','align','center','h1','h2','h3','hr','justify',
        'left','list','php','quote','right','table','td','th','tr'
    );
