...
<div align="center">Показывать заказы: 
    <a <? if ($filter == 'all'): ?>class="active"<? endif; ?> href="/dashboard/orders/quick">Все</a> 
    <a <? if ($filter == 'disable'): ?>class="active"<? endif; ?> href="/dashboard/orders/quick/disable">Не обработанные</a> 
    <a <? if ($filter == 'enable'): ?>class="active"<? endif; ?> href="/dashboard/orders/quick/enable">Обработанные</a>
</div>
