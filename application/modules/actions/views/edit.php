...
<?=form_open_multipart('dashboard/actions/edit/'.$page_info['ID'],array('name'=>'editform'));?> 
		...
		<td>Фото:<br/>
			<?php 
				if(!empty($page_info['image']) && $page_info['image']!='no_image.jpg'){
					print "<img src='".base_url().'uploads/articles/'.$page_info['image']."' style='max-height:150px;'/><br/>";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=anchor('dashboard/actions','Отменить',array('class' => "save"))?>
