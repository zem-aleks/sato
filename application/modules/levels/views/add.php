...
<?= form_open_multipart('dashboard/levels/add', array('name' => 'editform')); ?> 
<table border="0" cellpadding="5" cellspacing="5">
    <tbody>
        <tr height="45">	
            <td class="theadl">
                Название:<br/>
                <input style="width: 100%" id="name" name="name" size="80" value="" maxlength="255" type="text">		
            </td>
        </tr>
        <tr height="45">	
            <td class="theadl">
                Срок обучения (академ. часов):<br/>
                <input style="width: 100%" id="term" name="term" size="80" value="" maxlength="255" type="text">		
            </td>
        </tr>
        <tr height="45">	
            <td class="theadl">
                Словарный запас (слов):<br/>
                <input style="width: 100%" id="words" name="words" size="80" value="" maxlength="255" type="text">		
            </td>
        </tr>
        <tr height="45">
            <td class="theadl">
